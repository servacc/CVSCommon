...
#define HELPER_VALUE_BASE(name, type, config_value_kind, default_declaration, default_type, ...)                    \
  0 > Dummy_##name;                                                                                                 \
                                                                                                                    \
 protected:                                                                                                         \
...
#define VALUE(name, type, ...) \
  HELPER_VALUE_BASE(name, type, cvs::common::ConfigValueKind::BASE, , void, __VA_OPT__(__VA_ARGS__))

#define VALUE_OPTIONAL(name, type, ...) \
  HELPER_VALUE_BASE(name, type, cvs::common::ConfigValueKind::OPTIONAL, , void, __VA_OPT__(__VA_ARGS__))
...
#define HELPER_OBJECT_BASE(object_name, is_optional, ...)                                                           \
